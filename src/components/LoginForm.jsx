...
import { Eye, EyeOff, GraduationCap, Building2, Lock } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <button onClick={()=>navigate("/signup")} className="text-blue-600 cursor-pointer hover:text-blue-700 font-medium">
